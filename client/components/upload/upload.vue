<template lang="pug">
  div
      ...
      vue-clip(:options="options" :on-added-file="uploadFile") 
        .container.drop-files.text-center(slot="clip-uploader-action") 
          form.form.container-fluid(role="form" onsubmit="return false;") 
            .row 
              img.img-fluid.col-md-2.offset-md-5.upload-files-img(src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a1/Circle-icons-upload.svg/512px-Circle-icons-upload.svg.png") 
            .row.dz-message 
    ...
    div(v-else) 
      div(v-if="animated") 
        .progress-box
          .inside-blue.row.justify-content-between 
            .col-md-5
...
export default class upload extends Vue {
  ...
  async onSubmit() {
    ...
    const url = "/homework/upload/" + this.id + "/" + this.userId;
    try {
